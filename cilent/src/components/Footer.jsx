...
const Footer = () => {
  return (
    <footer className="relative border-t border-gray-800 mt-12 bg-gradient-to-b from-gray-900 to-black text-gray-400 overflow-hidden">
      
      {/* Decorative Background Elements */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-white/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-60 h-60 bg-gray-700/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 max-w-full px-6 lg:px-16 xl:px-24 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="relative">
              <div className="absolute inset-0 bg-white/10 blur-md group-hover:blur-lg transition-all"></div>
              {/* SVG Logo Silhouette */}
            ...
            <span className="text-base font-black text-white tracking-tight relative z-10">
              Car<span className="text-gray-300 font-extrabold">Dekho</span>
            </span>
          </div>
          ...
          <div className="flex gap-4">
            {/* Social Icons */}
            {[
              { img: assets.facebook_logo, bg: "bg-white/10 hover:bg-white/20" },
              { img: assets.instagram_logo, bg: "bg-white/10 hover:bg-white/20" },
              { img: assets.twitter_logo, bg: "bg-white/10 hover:bg-white/20" },
              { img: assets.gmail_logo, bg: "bg-white/10 hover:bg-white/20" }
            ].map((social, index) => (
              <div key={index} className={`p-2 rounded-full cursor-pointer transition-all duration-250 hover:scale-110 ${social.bg} invert`}>
        ...
        <div className="space-y-3">
          <h4 className="font-black text-sm text-white uppercase tracking-wider relative inline-block">
            Quick Links
            <div className="absolute -bottom-1 left-0 w-8 h-[3px] bg-white rounded-full"></div>
          </h4>
          <ul className="space-y-2 text-gray-400 text-xs font-semibold">
            <li className="cursor-pointer hover:text-white transition-colors flex items-center gap-1.5 group">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2.5 text-gray-400 text-xs font-semibold">
      ...
      {/* BOTTOM BAR */}
      <div className="relative z-10 border-t border-gray-800 bg-black/40">
        <div className="max-w-full px-6 lg:px-16 xl:px-24 py-4 flex flex-col sm:flex-row items-center justify-between text-xs">
          <p className="text-gray-500 font-medium">
            © {new Date().getFullYear()} <span className="font-bold text-white">CarDekho</span>. Kota, Rajasthan.
          </p>
